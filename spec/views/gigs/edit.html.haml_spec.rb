...
describe "gigs/edit.html.haml" do
  before(:each) do
  ...
  it "renders the edit gig form" do
    ...
    rendered.should have_selector("form", :action => gig_path(@gig), :method => "post") do |form|
      ...
      form.should have_selector("input#gig_creator_id", :name => "gig[creator_id]")
